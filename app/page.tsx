    ...
    <main className="min-h-screen flex items-center justify-center" style={{ background: 'var(--color-bg)' }}>
      ...
      <div className="text-center max-w-lg px-6 relative z-10">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl text-white font-semibold text-sm cursor-pointer transition-all hover:shadow-xl"
          style={{ background: 'linear-gradient(135deg,#6366F1,#8B5CF6)', boxShadow: '0 2px 12px rgba(99,102,241,.25)' }}
        >
          {projects.length > 0 ? <><Plus size={15} /> New product brain</> : <>Create your first product brain <ArrowRight size={15} /></>}
        </button>
